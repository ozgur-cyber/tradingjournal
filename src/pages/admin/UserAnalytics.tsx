  ...
  return (
    <div className="bg-bg-surface border border-border-primary rounded-xl p-6">
      <div className="flex items-center space-x-4 mb-6 pb-6 border-b border-border-primary">
        ...
        <div>
          <h1 className="text-2xl font-bold text-text-primary">Kullanıcı Analizi</h1>
          <p className="text-text-secondary">İşlem geçmişi, performans ve risk skoru yönetimi.</p>
        </div>
      </div>
